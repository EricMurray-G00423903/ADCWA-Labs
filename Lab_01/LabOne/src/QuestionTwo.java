...
public static void partOne() {
		...
		//Part One - Run a SELECT all query JOIN for two tables
		try {
			...
			//Query to Run
			String query = "SELECT s.sid, s.fname, s.surname, s.dob, sc.city, sc.commission " +
			               "FROM salesperson_table s " +
			               "JOIN salesperson_city_table sc ON s.sid = sc.sid";
